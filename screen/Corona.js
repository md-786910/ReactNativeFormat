...
let url = ` https://newsapi.org/v2/everything?q=Corona&apiKey=${api}&pageSize=100&page=1`;

url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=${api}&pageSize=100&page=1`;
